...
#define PRODUCT_AUTHOR "NekoMeow"
#define PRODUCT_URL "http://www.xein.xyz"
#define PRODUCT_EMAIL "-- no email contact right now--"

// SyPB -------------------------
#define SYPB_NAME "SyPB"
#define SYPB_VERSION "Beta 1.50"
#define SYPB_VERSION_F 1.50
#define SYPB_VERSION_DWORD 1,50,20201218,780 // yyyy/mm/dd  

#define SWNPC_NAME "SwNPC"
#define SWNPC_VERSION "Beta 1.50"
#define SWNPC_VERSION_F 1.50
#define SWNPC_VERSION_DWORD 1,50,20201209,128 // yyyy/mm/dd   

#define SYPBAPI_NAME "SyPB AMXX API"
#define SYPBAPI_VERSION "Beta 1.50"
#define SYPBAPI_VERSION_F 1.50
#define SYPBAPI_VERSION_DWORD 1,50,20201209,51    // yyyy/mm/dd   
